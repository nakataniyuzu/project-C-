...
//コンストラクタ
CObjThunder::CObjThunder(float x, float y)
{
	m_x = x;
	m_y = y;
...
void CObjThunder::Init()
{
	...
	m_time = 50;	//魔法が消える時間
					...
					//当たり判定用HitBoxを作成
	Hits::SetHitBox(this, m_x, m_y, ALL_SIZE, ALL_SIZE, ELEMENT_MAGIC, OBJ_THUNDER, 1);
}

//アクション
void CObjThunder::Action()
{
	if (m_hit_up == true)	//上
		m_hit = true;

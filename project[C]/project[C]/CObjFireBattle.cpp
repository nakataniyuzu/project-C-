...
//コンストラクタ
CObjFireBattle::CObjFireBattle(float x, float y)
{
	m_x = x;
	m_y = y;
...
void CObjFireBattle::Init()
{
	...
	//当たり判定用HitBoxを作成
	Hits::SetHitBox(this, m_x, m_y, ALL_SIZE, ALL_SIZE, ELEMENT_ATTACK, OBJ_FIRE_BATTLE, 1);
}

//アクション
void CObjFireBattle::Action()
{
